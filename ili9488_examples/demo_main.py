...
def rainbow():
    ...
    for y in range(12, 32):
        color = (y & 0x001F)
        tft.fill_rect(0, (y - 12) * 4 + 320, SCREEN_WIDTH, 4, color)
        time.sleep_ms(delay)
        
    #red-blue
    for y in range(12, 32):
        color = ((y << 11) & 0xF800) | (y & 0x001F)
        tft.fill_rect(0, (y - 12) * 4 + 400, SCREEN_WIDTH, 4, color)
        time.sleep_ms(delay)    
...
tft.draw_text_fast( text, 10, 20, COLOR_GRAY, COLOR_BLUE )
time.sleep_ms(500)
