...
def button(label, x, y, width, height, color, bg, state = 0):
    ...
    if state == 0:
        ...
        tft.draw_text(label, x + 20, y + 10, bg)    
        ...
        tft.draw_text(label, x + 20 + sh, y + 10 + sh, bg)  
...
while True:
    ...
    tft.fill_rect(20, 240, 200, 70, COLOR_BLACK) # clear test field
    tft.draw_text('X = ' + str(x) + '  Y = ' + str(y), 40, 250, COLOR_GREEN)
